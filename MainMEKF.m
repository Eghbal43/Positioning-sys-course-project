...
% Data is obtained from using phyphox application on A80 Samsung
...
%%% load phyphox data 
accel_table = readtable("data/Accelerometer.csv");
gyro_table = readtable("data/Gyroscope.csv");
mag_table = readtable("data/Magnetometer.csv");
